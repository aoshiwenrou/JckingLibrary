package com.jcking.lib.framework.module.utils;
    ...
    public static <T> List<T> getObjectsWithInterface(Context context, Class<T> clazz, String path) {
        ...
        try {
            ...
            if (objectList.size() == 0) {
                JLog.e(TAG, "No files were found, check your configuration please!");
            }
        } catch (Exception e) {
            e.getStackTrace();
            JLog.e(TAG, "getObjectsWithInterface error, " + e.getMessage());
        }
    ...
    public static List<String> getFileNameByPackageName(Context context, String packageName) throws PackageManager.NameNotFoundException, IOException {
        ...
        for (String path : getSourcePaths(context)) {
            ...
            try {
                ...
                JLog.e(TAG, "Scan map file in dex files made error. " + ignore);
            } finally {
                if (null != dexfile) {
                    try {
                        dexfile.close();
