package com.jcking.lib.framework.manager;

import android.content.Context;
import android.content.res.AssetManager;

import com.jcking.lib.framework.base.BaseApplication;
import com.jcking.lib.framework.module.entity.ModuleInfo;
import com.jcking.lib.framework.module.interfaces.IApplicationDelegate;
import com.jcking.lib.framework.module.utils.ModuleClassUtils;
        ...
        try {
            ...
            for(int i = 0; i < fileLength; ++i) {
                ...
                if(fileName.startsWith(MODULE_PREFIX)) {
                    ...
                    JLog.d(TAG, "load Module: " + moduleInfo.getModuleName());
                }
            }
